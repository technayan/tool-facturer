            ...
            <Container>
                <Row>
                    ...
                    <div className="col-md-4">
                        ...
                        <p className='text-light'><i class="bi bi-geo-alt text-warning me-2"></i>Muldoon Ave, New York, USA.</p>
                        <p className='text-light'><i class="bi bi-telephone text-warning me-2"></i>+8801944516122</p>
                        <p className='text-light'><i class="bi bi-envelope text-warning me-2"></i><a href="mailto:nayan050620@gmail.com" className='text-light'>nayan050620@gmail.com</a></p>
                        <div>
                            <a href="https://www.facebook.com/dev.nayan20" className='me-3 social-link text-warning'><i class="bi bi-facebook"></i></a>
                            <a href="https://www.linkedin.com/in/md-abdullah-nayan-711884220/" className='mx-3 social-link text-warning'><i class="bi bi-linkedin"></i></a>
                            <a href="https://twitter.com/dev_nayan1" className='mx-3 social-link text-warning'><i class="bi bi-twitter"></i></a>
                        </div>
                    </div>
                </Row>
            </Container>
